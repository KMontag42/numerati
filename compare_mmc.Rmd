...
g_compare_mmc <-
  ...
  geom_path(aes(x = Round_Number, y = MMC, group = Username, colour = Username), size = 0.3, alpha = 0.95)
...
ggplotly(g_compare_mmc) %>% config(displayModeBar = FALSE)
```
