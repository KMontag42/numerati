...
g_compare_corr <-
  ...
  geom_path(aes(x = Round_Number, y = Round_Correlation, group = Username, colour = Username), size = 0.3, alpha = 0.95)
...
ggplotly(g_compare_corr) %>% config(displayModeBar = FALSE)
```
